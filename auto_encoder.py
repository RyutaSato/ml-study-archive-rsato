...
def main():
    ...
    x_train_new_feature.to_pickle("models/kdd99_features/x_train-drop+ae_35_df&activation=relu&epochs=5&batch_size"
                                  "=32"
                                  ".pkl")
    x_test_new_feature.to_pickle("models/kdd99_features/x_test-drop+ae_35_df&activation=relu&epochs=5&batch_size=32"
                                 ".pkl")
