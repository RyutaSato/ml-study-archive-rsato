...
def main():
    ...
    model = Sequential([
        Dense(units=20, activation='relu', input_dim=38, name='encoder1'),
    ...
    x_train_new_feature.to_pickle("models/kdd99_features/x_train+ae_48_df&activation=relu&epochs=5&batch_size=32"
                                  ".pkl")
    x_test_new_feature.to_pickle("models/kdd99_features/x_test+ae_48_df&activation=relu&epochs=5&batch_size=32.pkl")
